const experience = [
    {
        ...
        desc: [
            `
                Tối ưu backend cho hệ thống khóa học và quản trị nội
                bộ bằng Laravel API.
            `,

            `
                Làm quen với PostgreSQL, tối ưu hóa truy vấn data.
            `,

            `
                Test API với Postman, phát hiện và xử lý 50% lỗi logic từ
                phản hồi của Tester.
            `,

            `
                Đề xuất và triển khai giao diện người dùng cho module
                kéo-thả khóa học sử dụng VueJS, giảm thời gian phản
